...
**득점 순위** — 골든부트 레이스(득점 → 도움 순). 국기와 함께 상위 3위를 강조합니다.

[![득점 순위](docs/screenshots/players.png)](docs/screenshots/players.png)
...
service/PlayerStatsService   득점 순위 로딩·정렬(득점→도움, 골든부트 스냅샷)
