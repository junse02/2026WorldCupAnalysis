...
"전력 기반 추정")로 출처를 구분하며, 전 96경기에 확률이 붙어 있습니다. (위 홈 화면은 조별리그의
*추정* 확률, 아래 32강 카드는 *실제 배당* 기반 확률입니다.)

[![넉아웃 카드 — 실제 북메이커 배당 기반 승·무·패 확률](docs/screenshots/home-knockout.png)](docs/screenshots/home-knockout.png)
